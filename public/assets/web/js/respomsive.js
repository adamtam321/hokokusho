const listBox = document.querySelectorAll('.slider_item');
const wrapperBox = document.querySelector('.info');
const wrapperBox = document.querySelector('.background-company');
const reviewDiv = document.querySelector('.slider');
